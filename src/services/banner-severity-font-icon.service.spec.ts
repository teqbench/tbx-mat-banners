...
describe('TbxMatBannerSeverityFontIconService', () => {
    describe('with TBX_MAT_FONT_ICON_DEFAULT_FONT_SET token', () => {
        let service: TbxMatBannerSeverityFontIconService;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                providers: [
                    ...
                    {
                        provide: TbxMatBannerSeverityFontIconService,
                        useFactory: () => new TbxMatBannerSeverityFontIconService(),
                    },
                ],
            });
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                providers: [
                    {
                        provide: TbxMatBannerSeverityFontIconService,
                        useFactory: () => new TbxMatBannerSeverityFontIconService('material-symbols-outlined'),
                    },
                ],
            });
